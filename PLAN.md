...
3. Build tRPC context and base procedures:
   - `publicProcedure`
   - `protectedProcedure`
   - role-scoped cast guard helpers
...
1. Build authenticated shell and cast selection.
2. Implement pages:
   - Dashboard
   - Casts
...
1. Operator can onboard cast/provider credentials and provision an instance.
